...
//	 public static String api = "http://app.go2b2b.com/";
	public static String api = "http://apigsb.go2b2b.com/";
...
//			 String result = PmAutoTest.orderUpdate();
...
//			String result = PmAutoTest.getProductDetails();
...
//			String result =PmAutoTest.getSupplierDeliverTag();
//			String result=PmAutoTest.getBestProductStatis();
//			String result=PmAutoTest.marginQuery();
//			String result=PmAutoTest.getDiffPrice();
//			String result=PmAutoTest.getDiffData();
//			String result=PmAutoTest.transactionRelation();
//			String result =PmAutoTest.vertifySurfaceItemMatch();
			
//			String result =PmAutoTest.vertifySurfaceItemMatch();
//			String result =PmAutoTest.wintakelogin();
//			String result =PmAutoTest.getBroadcastMsg();
...
//			String result =PmAutoTest.dataChargePay();
			...
			//退件扫码入库
//			String result = PmAutoTest.getRefundOrderByExpress();
//			String result = PmAutoTest.addWorkSignIn();
//			String result = PmAutoTest.refundScanList();
			String result = PmAutoTest.refundDealList();
//			String result = PmAutoTest.getRefundItemByExpress();
//			String result = PmAutoTest.getRefundItemByTakeCode();
//			String result = PmAutoTest.updateRefundScanTk();
//			String result = PmAutoTest.assignRefundScanClerk();
//			String result = PmAutoTest.updateRelationWithRecord();
//			String result = PmAutoTest.modifyRefundScanInfo();
//			String result = PmAutoTest.dictExpress();
//			String result = PmAutoTest.updateWaitSell();
			
//			String result = PmAutoTest.getClerkList();
//			String result = PmAutoTest.getExpressList();
